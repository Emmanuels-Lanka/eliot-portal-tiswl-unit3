...
const BarChartGraph = ({ date, obbSheetId }: BarChartGraphProps) => {
  ...
  return (
    <>
      ...
      {chartData.length > 0 ? (
        <div className="w-full h-[450px]  border rounded-lg shadow-sm mb-2 overflow-scroll">
          <Card
            className="bg-slate-50 pr-2 rounded-xl  w-auto border-none shadow-none"
