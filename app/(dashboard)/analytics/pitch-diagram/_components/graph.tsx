...
const GraphCompo = ({ date, obbSheet }: any) => {
  ...
  return (
    <div>
      ...
      {chartData.length > 0 ? (
        <div className="bg-slate-50 w-full  border rounded-lg shadow-sm mb-2">
          <CardHeader>
            <CardTitle>
              <div className="flex justify-between items-center">
                ...
                <div className="">
                  <Button onClick={settingFlag}>Download Report</Button>
                </div>
              </div>
            </CardTitle>
          </CardHeader>
          <div className="overflow-scroll">
            <Card
              className="mx-auto bg-slate-50 max-w-full border-none shadow-none"
