...
INNER JOIN 
    "OperatorSession" os 
    ON os."operatorRfid" = o.rfid
INNER JOIN 
    "ProductionData" pd 
    ON pd."operatorRfid" = o.rfid 
    AND pd."timestamp" BETWEEN os."LoginTimestamp" AND os."LogoutTimestamp"
INNER JOIN "ObbOperation" oo on oo.id = os."obbOperationId"
INNER JOIN "Operation" opn on opn.id = oo."operationId"
WHERE 
    os."LoginTimestamp" BETWEEN '2024-12-01' AND '2024-12-03'
    AND pd."timestamp" BETWEEN '2024-12-01' AND '2024-12-03'
    AND o.rfid <> 'OP-00000'
    AND os."LogoutTimestamp" IS NOT NULL
GROUP BY 
    o.name, 
    o.rfid, 
    os."obbOperationId", 
