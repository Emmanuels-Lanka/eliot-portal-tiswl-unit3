...
const SelectDateOnly = ({
  ...
  return (
    <div className="mt-10 border px-12 pt-6 pb-10 rounded-lg bg-slate-100">
      <Form {...form}>
        <form
        ...
        >
          ...
          <Button
            ...
            className="flex max-md:w-full  w-1/2 gap-2 pr-5"
          >
