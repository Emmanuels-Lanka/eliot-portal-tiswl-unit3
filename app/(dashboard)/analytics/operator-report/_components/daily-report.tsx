...
const ReportTable = ({ obbSheets, operators }: AnalyticsChartProps) => {
  ...
  const processDatas = (data: newData[]) => {
    const effMap = data.map((d) => {
      ...
      const diff = Number(
        ((logout.getTime() - login.getTime()) / 60000 - 60).toFixed(2)
      );
          ...
          <div className="bg-slate-50 w-full border rounded-lg shadow-sm pl-4 pr-4 mt-10">
            ...
            <div ref={reportRef} className="mt-5 mb-10 ">
              ...
              <Table className="mt-5">
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-center w-[150px] bg-gray-100">
                      Date
                    </TableHead>
                    <TableHead className="text-center w-[60px] bg-gray-100">
                      Operation SMV
                    </TableHead>
                    <TableHead className="text-center w-[60px] bg-gray-100">
                      Daily Production
              ...
              <div className="flex justify-between items-center mt-[50px]">
                <div>
                  <p>
                    <a href="https://www.portal.eliot.global/">
