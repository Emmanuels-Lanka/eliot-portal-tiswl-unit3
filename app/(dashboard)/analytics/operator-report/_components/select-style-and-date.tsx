...
const OperatorSearch = ({ operators, handleSubmit }: OperatorSearchProps) => {
  const [searchTerm, setSearchTerm] = useState("");
  const [filteredOperators, setFilteredOperators] = useState<EmployeeRecord[]>(
    operators || []
  );
  ...
  return (
    <div className="mt-10 border px-12 pt-6 pb-10 rounded-lg bg-slate-100 shadow-md">
      <Form {...form}>
        <form
          ...
          <div className="w-full flex flex-col md:flex-row gap-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    <FormLabel className="text-base">Search Operator</FormLabel>
            ...
            <div className="md:w-2/5">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    <FormLabel className="text-base">Starting Date</FormLabel>
                    <Popover>
            ...
            <div className="md:w-2/5">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    <FormLabel className="text-base">Ending Date</FormLabel>
                    <Popover>
                      <PopoverTrigger asChild>
                        <FormControl>
                          <Button
