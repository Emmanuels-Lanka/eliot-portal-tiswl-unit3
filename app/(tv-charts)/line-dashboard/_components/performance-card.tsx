        ...
        <div className='h-full w-full bg-white py-4 pl-2 pr-6 flex items-center gap-x-2 rounded-xl drop-shadow-sm border'>
            ...
            <div className='w-full flex flex-col items-start'>
                <div className='w-full flex justify-between items-end'>
                    <p className='text-lg font-medium text-slate-500 tracking-[0.01em]'>Performance</p>
                    <p className={cn("mt-1 font-semibold text-3xl text-pink-600")}>{value ? `${value.toFixed(1)}%` : "NAN"}</p>
                </div>
